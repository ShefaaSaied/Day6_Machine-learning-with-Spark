...
public class DecisionTree {
    public static void main(String[] args) {
        ...
        PipelineModel DTmodel = pipeline.fit(airbnbDFTrainTransform);

        // Make predictions.
        airbnbDFTest=vectorAssembler.transform (airbnbDFTest.na().drop());
        Dataset<Row> predictions = DTmodel.transform(airbnbDFTest);
        ...
        DecisionTreeRegressionModel treeModel =
                (DecisionTreeRegressionModel) (DTmodel.stages()[1]);
